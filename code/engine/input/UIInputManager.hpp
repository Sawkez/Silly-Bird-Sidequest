...
class UIInputManager {
   private:
	...
	static inline UIAction _actions[_UI_ACTION_COUNT] = {{SDL_SCANCODE_LEFT, SDL_GAMEPAD_BUTTON_DPAD_LEFT, LV_KEY_LEFT},		  // left
														 {SDL_SCANCODE_RIGHT, SDL_GAMEPAD_BUTTON_DPAD_RIGHT, LV_KEY_RIGHT},		  // right
														 {SDL_SCANCODE_UP, SDL_GAMEPAD_BUTTON_DPAD_UP, LV_KEY_UP},				  // up
														 {SDL_SCANCODE_DOWN, SDL_GAMEPAD_BUTTON_DPAD_DOWN, LV_KEY_DOWN},		  // down
														 {SDL_SCANCODE_RETURN, SDL_GAMEPAD_BUTTON_SOUTH, LV_KEY_ENTER},			  // enter
														 {SDL_SCANCODE_ESCAPE, SDL_GAMEPAD_BUTTON_EAST, LV_KEY_ESC},			  // esc
														 {SDL_SCANCODE_UNKNOWN, SDL_GAMEPAD_BUTTON_INVALID, LV_KEY_PREV},		  // prev
														 {SDL_SCANCODE_TAB, SDL_GAMEPAD_BUTTON_INVALID, LV_KEY_NEXT},			  // next
														 {SDL_SCANCODE_BACKSPACE, SDL_GAMEPAD_BUTTON_INVALID, LV_KEY_BACKSPACE},  // backspace
														 {SDL_SCANCODE_DELETE, SDL_GAMEPAD_BUTTON_INVALID, LV_KEY_DEL},			  // del
														 {SDL_SCANCODE_HOME, SDL_GAMEPAD_BUTTON_INVALID, LV_KEY_HOME},			  // home
														 {SDL_SCANCODE_END, SDL_GAMEPAD_BUTTON_INVALID, LV_KEY_END}};			  // end
