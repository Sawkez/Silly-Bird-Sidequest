...
class DevConsoleVariableManager {
   public:
	enum DevConsoleVariableID {
		...
		PLAYER_REJUVENATOR_THRESHOLD,
		PLAYER_CEILING_DASH_VELOCITY,

		PLAYER_SQUISH_BASE_VELOCITY_X,
		PLAYER_SQUISH_BASE_VELOCITY_Y,
		PLAYER_SQUISH_ACCELERATION,
		PLAYER_SQUISH_MAX_VELOCITY,
		PLAYER_SQUISH_MIN_VELOCITY,
		PLAYER_SQUISH_DAMPENING,
		PLAYER_SQUISH_X_MIN,
		PLAYER_SQUISH_X_MAX,
		PLAYER_SQUISH_X_RESET,
		PLAYER_SQUISH_Y_MAX,
		PLAYER_SQUISH_DUCK,
		PLAYER_SQUISH_STAND_UP,
		PLAYER_SQUISH_TWERK_DOWN,
		PLAYER_SQUISH_TWERK_UP,
		PLAYER_SQUISH_SLIDE,
		...
		PLAYER_STATE_DUCK_GRAVITY,
		PLAYER_STATE_DUCK_JUMP_FORCE,

		PLAYER_STATE_LEDGE_OFFSET_HEIGHT,
		PLAYER_STATE_LEDGE_OFFSET_LEFT,
		PLAYER_STATE_LEDGE_OFFSET_RIGHT,
		PLAYER_STATE_LEDGE_SIDE_JUMP_FORCE_X,
		PLAYER_STATE_LEDGE_SIDE_JUMP_FORCE_Y,
		PLAYER_STATE_LEDGE_UP_JUMP_FORCE,
		PLAYER_STATE_LEDGE_UP_COOLDOWN,
		PLAYER_STATE_LEDGE_DOWN_COOLDOWN,
		...
		PLAYER_STATE_SLIDE_INITIAL_SPEED,
		PLAYER_STATE_SLIDE_SPEED,
		PLAYER_STATE_SLIDE_ULTRA_SLIDE_VELOCITY_MULT,
		PLAYER_STATE_SLIDE_GRAVITY,
		PLAYER_STATE_SLIDE_FRICTION,
		PLAYER_STATE_SLIDE_JUMP_FORCE,

		PLAYER_STATE_WALLRUN_STICK_ACCEL,
		PLAYER_STATE_WALLRUN_DROP_ACCEL,
		PLAYER_STATE_WALLRUN_STICK_VELOCITY,
		PLAYER_STATE_WALLRUN_GRAVITY,
		PLAYER_STATE_WALLRUN_MAX_DIST,
		PLAYER_STATE_WALLRUN_INITIAL_VELOCITY,
		PLAYER_STATE_WALLRUN_JUMP_FORCE_X,
		PLAYER_STATE_WALLRUN_JUMP_FORCE_Y,
		PLAYER_STATE_WALLRUN_DROP_VELOCITY,
