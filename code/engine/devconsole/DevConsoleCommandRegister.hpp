...
void Init() {
	...
	reg("loadModLevel", ConsoleCommandsMod::loadModLevel, DevConsoleCommand::FLAG_UNSAFE, CMD_MOD_LEVEL,
	...
	reg("loadModSkin", ConsoleCommandsMod::loadModSkin, DevConsoleCommand::FLAG_UNSAFE, CMD_MOD_SKIN,
	...
	reg("giveUpgrades", ConsoleCommandsPlayer::giveUpgrade, DevConsoleCommand::FLAG_CHEAT, CMD_PLAYER_GIVE_UPGRADES,
